    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: <Widget>[
            _createParagraph(
              'Agreement between User and twiine.com',
              """Welcome to twiine.com. The twiine.com website (the "Site") is comprised of various web pages
operated by Nex-ii LLC ("Nex-ii"). twiine.com is offered to you conditioned on your acceptance
without modification of the terms, conditions, and notices contained herein (the "Terms"). Your use
of twiine.com constitutes your agreement to all such Terms. Please read these terms carefully, and
keep a copy of them for your reference.
\ntwiine.com is a News and Information Site.
\nOur website provides information about Nex-ii's product, Twiine.""",
            ),
            _createParagraph(
                'Electronic Communications',
                """Visiting twiine.com or sending emails to Nex-ii constitutes electronic communications. You consent
...
your account to any other person or entity. You acknowledge that Nex-ii is not responsible for
third party access to your account that results from theft or misappropriation of your account.
Nex-ii and its associates reserve the right to refuse or cancel service, terminate accounts, or
remove or edit content in our sole discretion."""
            ),
            _createParagraph(
                'Children Under Thirteen',
                """Nex-ii does not knowingly collect, either online or offline, personal information from persons under
the age of thirteen. If you are under 18, you may use twiine.com only with permission of a parent
or guardian."""
            ),
            _createParagraph(
                'Links to Third Party Sites/Third Party Services',
                """twiine.com may contain links to other websites ("Linked Sites"). The Linked Sites are not under
the control of Nex-ii and Nex-ii is not responsible for the contents of any Linked Site, including
without limitation any link contained in a Linked Site, or any changes or updates to a Linked Site.
Nex-ii is providing these links to you only as a convenience, and the inclusion of any link does not
imply endorsement by Nex-ii of the site or any association with its operators.

Certain services made available via twiine.com are delivered by third party sites and organizations.
By using any product, service or functionality originating from the twiine.com domain, you hereby
acknowledge and consent that Nex-ii may share such information and data with any third party
with whom Nex-ii has a contractual relationship to provide the requested product, service or functionality on behalf of twiine.com users and customers."""
            ),
            _createParagraph(
                'No Unlawful or Prohibited Use/Intellectual Property',
                """You are granted a non-exclusive, non-transferable, revocable license to access and use twiine.com
strictly in accordance with these terms of use. As a condition of your use of the Site, you warrant
to Nex-ii that you will not use the Site for any purpose that is unlawful or prohibited by these
...
compilation thereof, and any software used on the Site, is the property of Nex-ii or its suppliers
...
Nex-ii content is not for resale. Your use of the Site does not entitle you to make any unauthorized
...
will make no other use of the content without the express written permission of Nex-ii and the
copyright owner. You agree that you do not acquire any ownership rights in any protected content.
We do not grant you any licenses, express or implied, to the intellectual property of Nex-ii or our
licensors except as expressly authorized by these Terms."""
            ),
            _createParagraph(
                'Third Party Accounts',
                """You will be able to connect your Nex-ii account to third party accounts. By connecting your Nex-
ii account to your third party account, you acknowledge and agree that you are consenting to the
...
not use this feature."""
            ...
            _createParagraph(
                'International Users',
                """The Service is controlled, operated and administered by Nex-ii from our offices within the USA. If
you access the Service from a location outside the USA, you are responsible for compliance with
all local laws. You agree that you will not use the Nex-ii Content accessed through twiine.com in
any country or in any manner prohibited by any applicable laws, restrictions or regulations."""
            ),
            _createParagraph(
                'Indemnification',
                """You agree to indemnify, defend and hold harmless Nex-ii, its officers, directors, employees, agents
...
of a third party, or your violation of any applicable laws, rules or regulations. Nex-ii reserves the
right, at its own cost, to assume the exclusive defense and control of any matter otherwise subject
to indemnification by you, in which event you will fully cooperate with Nex-ii in asserting any
available defenses."""
            ),
            _createParagraph(
                'Arbitration',
...
OTHER. Further, unless both you and Nex-ii agree otherwise, the arbitrator may not consolidate
...
INFORMATION HEREIN. NEX-II LLC AND/OR ITS SUPPLIERS MAY MAKE
IMPROVEMENTS AND/OR CHANGES IN THE SITE AT ANY TIME.

NEX-II LLC AND/OR ITS SUPPLIERS MAKE NO REPRESENTATIONS ABOUT THE
...
IS" WITHOUT WARRANTY OR CONDITION OF ANY KIND. NEX-II LLC AND/OR
...
SHALL NEX-II LLC AND/OR ITS SUPPLIERS BE LIABLE FOR ANY DIRECT,
...
NEX-II LLC OR ANY OF ITS SUPPLIERS HAS BEEN ADVISED OF THE POSSIBILITY
...
DISCONTINUE USING THE SITE."""
            ...
            _createParagraph(
                ...
                """Nex-ii reserves the right, in its sole discretion, to terminate your access to the Site and the related
...
you and Nex-ii as a result of this agreement or use of the Site. Nex-ii's performance of this
agreement is subject to existing laws and legal process, and nothing contained in this agreement is
in derogation of Nex-ii's right to comply with governmental, court and law enforcement requests or
requirements relating to your use of the Site or information provided to or gathered by Nex-ii with
...
and Nex-ii with respect to the Site and it supersedes all prior or contemporaneous communications
and proposals, whether electronic, oral or written, between the user and Nex-ii with respect to the
...
and all related documents be written in English."""
            ...
            _createParagraph(
                'Changes to Terms',
                """Nex-ii reserves the right, in its sole discretion, to change the Terms under which twiine.com is
offered. The most current version of the Terms will supersede all previous versions. Nex-ii
encourages you to periodically review the Terms to stay informed of our updates."""
            ),
            _createParagraph(
                'Contact Us',
                """Nex-ii welcomes your questions or comments regarding the Terms:
Nex-ii LLC
82 Ray
